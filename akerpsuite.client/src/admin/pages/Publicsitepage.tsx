...
const MODULES: ModuleConfig[] = [
    ...
    },
    {
        ...
        columns: [
            { key: "avatarImagePath", label: "Photo", type: "image" },
    ...
    },
    {
        ...
        image: "none",
        idField: "id",
        list: adminService.getVideos,
        create: adminService.createVideo,
        update: adminService.updateVideo,
        remove: adminService.deleteVideo,
        columns: [
            { key: "title", label: "Title" },
            { key: "youTubeVideoUrl", label: "YouTube URL" },
            { key: "displayOrder", label: "Order" },
            { key: "isActive", label: "Active", type: "bool" },
        ],
        fields: [
            { name: "title", label: "Title", type: "text", required: true },
            { name: "youTubeVideoUrl", label: "YouTube Video URL", type: "text", required: true },
            { name: "description", label: "Description", type: "textarea" },
            { name: "displayOrder", label: "Display Order", type: "number", default: 0 },
            { name: "isActive", label: "Active", type: "checkbox", default: true },
        ],
